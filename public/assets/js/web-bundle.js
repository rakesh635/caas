...
(function () {
  ...
  var theme = require('./../../theme/js/index');
...
},{"./../../theme/js/index":23,"./docs":24,"./sidemenu.js":25}],2:[function(require,module,exports){
...
(function () {
 ...
 // var ISChart = require('./ISChart');
  ...
  $(window).load(function () {
      ...
      $(".animated-preloader-wrap").fadeOut("slow");
      $(".animated-preloader-wrap-index").fadeOut("slow");
  });
...
},{"bootstrap":2,"jquery":21,"jquery.sticky":20,"leaflet":22}],24:[function(require,module,exports){
(function () {
    ...
    init: function() {
      ...
      var initHeader = function () {
        ...
        $(window).on('scroll', function (e) {
            ...
            if ($('body').hasClass('mimimal-always')) {
                    $('#header-main').addClass("minimal");
                    $('#side-menu').addClass("minimal");
            }
            else {
                if (scrollTop >= 60) {
                    $('#header-main').addClass("minimal");
      ...
      var initFooterMap = function () {
        if ($('#footerMap').length > 0) {
          var footerMap = L.map('footerMap', {
            ...
            minZoom: 15,
            maxZoom: 19,
            center: [-26.043288, 28.023634],
            attributionControl: false,
            zoomControl: true,
            scrollWheelZoom: false,
            inertia: false
          }).setView([-26.043288, 28.023634], 16);
      ...
      /*
      $('.equal-height-panels').each(function (index) {
        var maxHeight = 0;
      ...
      */
      ...
      // Prevent in page links from reloading the page
        ...
        $sidebar.affix({
          offset: {
            top: function () {
              ...
              var navOuterHeight = $('#header-main').height();

              //return (this.top = 100);//offsetTop - navOuterHeight - sideBarMargin + 20);
              return (this.top = offsetTop - navOuterHeight - sideBarMargin + 200);
            },
            bottom: function () {
...
(function () {
    ...
    var mmenu = require('./../../../node_modules/jquery.mmenu/dist/core/js/jquery.mmenu.min.js');
    var mmenu = require('./../../../node_modules/jquery.mmenu/dist/addons/js/jquery.mmenu.searchfield.min.js');
    var mmenu = require('./../../../node_modules/jquery.mmenu/dist/addons/js/jquery.mmenu.navbars.min.js');
    var mmenu = require('./../../../node_modules/jquery.mmenu/dist/addons/js/jquery.mmenu.autoheight.min.js');
    var mmenu = require('./../../../node_modules/jquery.mmenu/dist/addons/js/jquery.mmenu.counters.min.js');


}());
},{"./../../../node_modules/jquery.mmenu/dist/addons/js/jquery.mmenu.autoheight.min.js":15,"./../../../node_modules/jquery.mmenu/dist/addons/js/jquery.mmenu.counters.min.js":16,"./../../../node_modules/jquery.mmenu/dist/addons/js/jquery.mmenu.navbars.min.js":17,"./../../../node_modules/jquery.mmenu/dist/addons/js/jquery.mmenu.searchfield.min.js":18,"./../../../node_modules/jquery.mmenu/dist/core/js/jquery.mmenu.min.js":19}]},{},[1]);
